...
fn and(x: i32, y:i32)->i32 { x & y }
fn or(x: i32, y:i32)->i32 { x | y }
#[allow(unused_variables)]
fn not(x: i32, y:i32)->i32 { !y }
#[allow(unused_variables)]
fn noop(x: i32, y:i32)->i32 { x }
fn lshift(x: i32, y:i32)->i32 { x << y }
fn rshift(x: i32, y:i32)->i32 { x >> y }


impl Argument {
    fn parse(s: &str)->Argument {
        if s.is_empty() { return Argument::None; }
